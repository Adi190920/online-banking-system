...
(1212598807,"Rishabh","Vignesh","Singh","rishabh231","password123","What is your pet's name","Timmy",2,"9982367794");
select * from users;
INSERT INTO users VALUES
(1212598808,"Anush","K","Verma","anush","password234","What is your pet's name","Oreo",1,"8082347794");
INSERT INTO users VALUES (1212598810,"Sara","L","Dsouza","sara1","Password_12","What is your pet's name","Oreo",1,"8082347794");
INSERT INTO users VALUES
(1212598811,"Sruthi","Bala","Krishnan","sruthi_bal","password_shru","What is your pet's name","Johnny",3,"9854909331");
INSERT INTO users VALUES (1212598823,"Karen","P","Smith","ksmith","pwd_123890","What is your pet's name","John",2,"6002323294");
select * from users;

INSERT INTO atmdetails VALUES(1,1443980761,2634);
